...
export const generateResponseStream = async (apiKey, userQuery, format, channelHistory, coreRules, isNewContext, signal) => {
  if (!apiKey) {
      throw new Error("API Key is missing. Please enter it in the modal.");
  }
