    ...
    <div className="fixed inset-0 bg-zinc-100/30 dark:bg-black/30 backdrop-blur-2xl flex items-center justify-center p-4 z-50 transition-opacity" role="dialog" aria-modal="true" aria-labelledby="modal-title">
      <div className="bg-white/70 dark:bg-black/70 border border-white/50 dark:border-white/10 rounded-3xl shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] max-w-md w-full p-8 relative overflow-hidden backdrop-blur-xl">
        ...
        <div className="flex flex-col items-center text-center mb-8">
            <div className="w-14 h-14 bg-gradient-to-br from-zinc-800 to-black dark:from-white dark:to-zinc-300 rounded-2xl flex items-center justify-center mb-4 shadow-xl">
                <span className="text-2xl font-bold text-white dark:text-zinc-900">G</span>
            </div>
            <h2 id="modal-title" className="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-2 tracking-tight">Unlock Gee AI</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            className="w-full py-4 px-4 bg-zinc-900 dark:bg-white hover:bg-black dark:hover:bg-zinc-200 text-white dark:text-zinc-900 font-bold rounded-2xl shadow-lg shadow-zinc-900/20 dark:shadow-white/10 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed transform hover:-translate-y-0.5 active:translate-y-0"
          >
            Get Started
          </button>
        </form>
